...
public class MundoJuego {
	...
	int X = aleatorio(10,990);
	int Y = aleatorio(10,740);

	/** Crea una nueva estrella y la añade al mundo y al panel visual
	 * @param posX	Posición X de pixel de la nueva estrella
	 * @param posY	Posición Y de píxel de la nueva estrella
	 */
